...
postRouter.post("/add",async(req,res)=>{
    try{
const {ProductName,Price,MedName,MedDega,HumDenge,OrderForm,RefundForm,DealType,TotalShared,LastShared,Hamaracommision,image,OrderLink,RefundTime,Other}=req.body

const post= await new postModel({ProductName,Price,MedName,MedDega,HumDenge,OrderForm,RefundForm,DealType,TotalShared,LastShared,Hamaracommision,image,OrderLink,RefundTime,Other})
post.save()
